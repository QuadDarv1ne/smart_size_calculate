...
`rich` - это библиотека, которая используется для форматирования текста в консоли. Она является единственной внешней зависимостью в вашем проекте.
